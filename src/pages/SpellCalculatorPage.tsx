  ...
  return (
    ...
    >
      ...
      <Card variant="parchment">
        ...
        {/* Power Calculations */}
        <div className="mb-4">
          <h3 className="text-sm font-display font-semibold text-gray-700 mb-2">⚡ Power Circuits</h3>
        ...
        {/* Low Voltage & Data */}
        <div className="mb-4">
          <h3 className="text-sm font-display font-semibold text-gray-700 mb-2">📡 Low Voltage & Data</h3>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
        ...
        {/* Controls & Automation */}
        <div>
          <h3 className="text-sm font-display font-semibold text-gray-700 mb-2">🤖 Controls & Automation</h3>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
