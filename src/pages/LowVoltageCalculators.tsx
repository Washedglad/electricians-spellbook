// Low Voltage Calculator Components
...
export function DataCableCalculator({ onResult }: { onResult: (result: CalculatorResult) => void }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-parchment/70 text-sm">
        Calculate maximum cable lengths for network data rates
      </p>
...
export function PoECalculator({ onResult }: { onResult: (result: CalculatorResult) => void }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-parchment/70 text-sm">
        Calculate Power over Ethernet requirements
      </p>
...
export function LowVoltagePowerCalculator({ onResult }: { onResult: (result: CalculatorResult) => void }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-parchment/70 text-sm">
        Calculate voltage drop for 12V/24V DC systems
      </p>
...
export function HVACWiringCalculator({ onResult }: { onResult: (result: CalculatorResult) => void }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-parchment/70 text-sm">
        Calculate wiring requirements for HVAC controls
      </p>
...
export function PLCIOCalculator({ onResult }: { onResult: (result: CalculatorResult) => void }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-parchment/70 text-sm">
        Calculate PLC I/O requirements for automation
      </p>
...
export function SecurityWiringCalculator({ onResult }: { onResult: (result: CalculatorResult) => void }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-parchment/70 text-sm">
        Calculate wiring for security and access control
      </p>
